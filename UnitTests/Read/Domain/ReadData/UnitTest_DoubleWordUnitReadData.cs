...
namespace UnitTests.Read.Domain.ReadData
{
    public class UnitTest_DoubleWordUnitReadData
    {
        ...
        {
            // Arrange
            var deviceCode = new DeviceCode(new byte[] { 0xA8 }, "D", DeviceType.DoubleWord, DeviceNoRange.Dec);
        ...
        {
            // Arrange
            var deviceCode1 = new DeviceCode(new byte[] { 0xA8 }, "D", DeviceType.DoubleWord, DeviceNoRange.Dec);
            var deviceCode2 = new DeviceCode(new byte[] { 0xA8 }, "D", DeviceType.DoubleWord, DeviceNoRange.Dec);
