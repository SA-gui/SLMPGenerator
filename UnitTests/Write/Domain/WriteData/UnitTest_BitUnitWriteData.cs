...
namespace UnitTests.Write.Domain.WriteData
{
    ...
    public class UnitTest_BitUnitWriteData
    {
        ...
        {
            // Arrange
            var deviceCode1 = new DeviceCode(new byte[] { 0xA8 }, "D", DeviceType.Bit, DeviceNoRange.Dec);
            var deviceCode2 = new DeviceCode(new byte[] { 0x00 }, "A", DeviceType.Bit, DeviceNoRange.Dec);
