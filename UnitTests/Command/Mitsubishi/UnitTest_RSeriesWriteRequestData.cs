...
namespace UnitTests.Command.Mitsubishi
{
    public class UnitTest_RSeriesWriteRequestData
    {
        ...
        /// </summary>
        [Theory]
        [InlineData(0x1234, 10, new byte[] { 0x01, 0x14, 0x02, 0x00, 0x34, 0x12, 0x00, 0x00, 0xA8, 0x00, 0x01, 0x00, 0x0a, 0x00 }, "14010002D***000012340001000A")]
        [InlineData(0x5678, 20, new byte[] { 0x01, 0x14, 0x02, 0x00, 0x78, 0x56, 0x00, 0x00, 0xA8, 0x00, 0x01, 0x00, 0x14, 0x00 }, "14010002D***0000567800010014")]
        ...
        /// </summary>
        [Theory]
        [InlineData(0x1234, false, new byte[] { 0x01, 0x14, 0x03, 0x00, 0x34, 0x12, 0x00, 0x00, 0xA8, 0x00, 0x01, 0x00, 0x00, 0x00 }, "14010003D***0000123400010000")]
        [InlineData(0x5678, true, new byte[] { 0x01, 0x14, 0x03, 0x00, 0x78, 0x56, 0x00, 0x00, 0xA8, 0x00, 0x01, 0x00, 0x01, 0x00 }, "14010003D***0000567800010001")]
