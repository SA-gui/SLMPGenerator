...
namespace SLMPGenerator.Read.Domain
{
    public class ReadResponseResolver
    {
        ...
        public ReadResponseResolver(MessageType messageType, DeviceAccessType devAccessType, ushort numberOfDevicePoints)
        {
        ...
        public List<short> Resolve(byte[] response)
        {
        ...
        private List<short> ResolveBinaryResponse(byte[] rawResponse, DeviceAccessType devAccsessType, ushort numberOfDevicePoints, ushort responseDataUnitLength)
        {
            ...
            if (DeviceAccessType.Bit == devAccsessType)
            {
                ...
                {
                    int fromBase = 16;
                    short convertedValue = Convert.ToInt16(c.ToString(), fromBase);
                    result.Add(convertedValue);
                }
                return result;
            }
        ...
        {
            return obj is ReadResponseResolver other && MessageType.Equals(other.MessageType) && DeviceAccessType.Equals(other.DeviceAccessType);
        }
