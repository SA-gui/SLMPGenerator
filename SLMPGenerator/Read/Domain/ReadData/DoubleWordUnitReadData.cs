...
namespace SLMPGenerator.Read.Domain.ReadData
{
    internal class DoubleWordUnitReadData 
    {
        ...
        {
            return obj is DoubleWordUnitReadData other && DeviceCode.Equals(other.DeviceCode) && StartAddress.Equals(other.StartAddress) && NumberOfDevicePoints.Equals(other.NumberOfDevicePoints);
        }
    }
}
