...
{
    internal class DoubleWordUnitAccessData
    {
        ...
        public DoubleWordUnitAccessData(DeviceCode deviceCode, ushort address, ushort numberOfDevPoints)
        {
        ...
        {
            return obj is DoubleWordUnitAccessData other && DeviceCode.Equals(other.DeviceCode) && Address.Equals(other.Address) && NumberOfDevicePoints.Equals(other.NumberOfDevicePoints);
        }
    }
}
