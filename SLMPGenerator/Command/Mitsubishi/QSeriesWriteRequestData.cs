...
{
    internal class QSeriesWriteRequestData : IRequestData
    {
        ...
        internal QSeriesWriteRequestData(DeviceCode deviceCode, WordUnitWriteData wordUnitWriteData)
        {
        ...
        internal QSeriesWriteRequestData(DeviceCode deviceCode, BitUnitWriteData bitUnitWriteData)
        {
            DeviceType = deviceCode.DeviceType;
        ...
        {
            return obj is QSeriesWriteRequestData other && ASCIICode.Equals(other.ASCIICode);
        }
    }
}
